...
export default function Header({ navItems = [], headerText }: HeaderProps) {
  ...
  const menuButtonText = headerText?.menu || { uz: 'MENU', ru: 'МЕНЮ', en: 'MENU' };
  const closeButtonText = headerText?.close || { uz: 'YOPISH', ru: 'ЗАКРЫТЬ', en: 'CLOSE' };
